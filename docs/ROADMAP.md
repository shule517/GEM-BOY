...
| フェーズ | ステップ数 | 想定時間 | 到達点 |
|---|---|---|---|
| A. 土台 | 3 | 3〜4h | ROMが読める、シリアル出力が動く |
| B. CPU基礎 + Blargg初級 | 3 | 4〜6h | `06-ld r,r` Passed |
| C. CPU拡張 + Blargg中級 | 3 | 4〜6h | `04`, `05`, `11` Passed |
| D. PPU実装 + HelloWorld | 3 | 3〜5h | **HelloWorld表示** |
| E. ブートROM対応 | 3 | 4〜7h | **Nintendoロゴ表示** |
