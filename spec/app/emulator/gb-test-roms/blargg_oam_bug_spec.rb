...
# Blargg oam_bug 個別 ROM のシナリオ
#
# https://github.com/retrio/gb-test-roms の oam_bug/rom_singles/ にある 8 個の ROM を
# 1 つずつ skip_boot で起動し、DMG 実機固有の OAM 破壊バグ
# (INC/DEC rr 等が OAM 域 0xFE00-0xFE9F を指す瞬間に走ると OAM が壊れる)を
# 正しく再現できているかを検証する。
